...
def get_company_owner_by_sunbiz(company_name):
    # Get driver instance
    driver = get_driver()
    ...
    # MAIN FUNCTION
    try:
        if check_exists("id", "SearchTerm", driver):
            # Get Search Input
            driver.find_element(
                "id",
                "SearchTerm"
            ...
            if company_name in first_company_name \
                    and first_corp_name_checker != "INACT" \
                    and first_corp_name_checker != "INACT/UA" \
                    and first_corp_name_checker != "INACT/CV" \
                    and first_corp_name_checker != "InActive":
                ...
                return full_name, owner_first_name, owner_last_name
                    ...
                    and second_corp_name_checker != "INACT" \
                    and second_corp_name_checker != "INACT/UA" \
                    and second_corp_name_checker != "INACT/CV" \
                    and second_corp_name_checker != "InActive":
                # Get First and Last Name of Owner
                driver.find_element(by="xpath",
                                    value="/html/body/div[1]/div[1]/"
                                          "div[2]/div/div[2]/table/tbody/tr[2]/td[1]/a").click()
                time.sleep(0.2)
                full_name = driver.find_element(by="xpath",
                                                value="/html/body/div[1]/div[1]/"
                                                      "div[2]/div/div[2]/div[5]/span[2]"
                                                ).text
                ...
                print("Sunbiz has no such company name \n")
                return None
        else:
